...
public class ExamplePlayerScript : CaptainsMessPlayer
{
	...
	public override void OnStartLocalPlayer()
	{
		...
		CharacterButtonController = GameObject.Find ("Character Button Controller").GetComponent<CharacterButtonController> ();
		CharacterButtonController.SetLocalPlayer(this);
